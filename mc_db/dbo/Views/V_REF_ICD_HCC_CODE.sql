...
FROM            [$(pics_db)]..REF_ICD9_HCC_HIST H INNER JOIN
                         [$(pics_db)]..REF_HCC_HIST HH ON H.hcc_id = HH.hcc_id INNER JOIN
                        [$(pics_db)]..REF_ICD9 i9 ON i9.icd9_code = H.icd9_code
...
FROM            [$(pics_db)]..REF_ICD10_HCC_HIST H INNER JOIN
                         [$(pics_db)]..ref_icd10 i10 ON i10.icd10_code = H.icd10_code INNER JOIN
                         [$(pics_db)]..REF_HCC_HIST HH ON H.hcc_id = HH.hcc_id
